...
echo "terraform apply -var=\"gcp_account_name=${gcp_account_name}\" -var=\"org_id=${org_id}\" -var=\"billing_account=${billing_account}\" -var=\"project_id=chocolate-ai-demo\""
...
terraform apply -auto-approve \
  ...
  -var="project_id=chocolate-ai-demo"
